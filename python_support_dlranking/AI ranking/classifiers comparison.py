...
with open('data/auto_training.csv', newline='') as csvfile:
...
with open('data/humanlabelled.csv', newline='') as csvfile:
    data_iter = csv.reader(csvfile, delimiter=',', quotechar='|')
...
names = ["Logistic regression", "Linear SVM", "KNN", "Decision tree", "Random forest"] # "Non-linear SVM"]
shorts = ["lr", "svm", "knn", "tree", "rf"]
